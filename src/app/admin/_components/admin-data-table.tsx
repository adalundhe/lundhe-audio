...
import { AdminTableColumnsControl } from "./admin-table-columns-control";
import { AdminTableFilterControls } from "./admin-table-filter-controls";
...
export function SimpleFilterOption({
  ...
  return (
    <AdminCheckboxRow
      className={cn(
        "w-full outline-none border-none hover:bg-white dark:hover:bg-black hover:underline",
  ...
  return (
    <div className="flex min-w-0 flex-col">
      <div className="flex flex-wrap items-center gap-4 py-4">
        ...
        <AdminTableFilterControls
          table={table}
          filterTabs={filterTabs}
          menuClassName={courierPrime.className}
        />
