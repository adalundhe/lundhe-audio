                ...
                <CardFooter className="mt-4">
                    <div className="flex flex-col w-full items-center">
                        ...
                        <Link onClick={() => setFormState({
                            formStatus: "active"
                        })} href="/legal/privacy" className="my-2 text-lg font-light text-muted-foreground hover:underline">privacy</Link>
                        <Link onClick={() => setFormState({
                            formStatus: "active"
                        })} href="/legal/terms-of-service" className="text-lg font-light mb-2 text-muted-foreground hover:underline">terms of service</Link>
