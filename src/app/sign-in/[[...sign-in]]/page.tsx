      ...
      <Card className="w-full md:w-3/4 h-full rounded-none border-none shadow-none flex flex-col items-center justify-center">
        {
          ...
          <div className="flex flex-col items-center justify-center border rounded-sm mt-8 mb-4 h-[500px]">
            <CardHeader className="text-center">
                ...
                <CardDescription>Sign in to access Lündhé Audio</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="text-center text-muted-foreground text-sm flex flex-col items-center gap-2">
                  ...
                  <Button className="border border-black hover:bg-black hover:text-white dark:border-white dark:text-white dark:hover:border-cyan-500 dark:hover:text-cyan-500 w-fit px-4 py-4 text-lg">
          ...
          :
          <div className="flex flex-col w-full h-[500px] items-center justify-center mt-8">
            <ScaleLoader/>
          </div>
        }
