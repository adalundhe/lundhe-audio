...
export default async function SignInContinueLayout() {
    ...
    return (   
        <Layout>
            <Card className="max-w-[500px] rounded-none border-none shadow-none flex flex-col items-center justify-center">
                <div className="flex flex-col items-center justify-center border rounded-sm mt-8 mb-4 2xl:w-1/3 xl:w-1/2 w-3/4 rounded-sm border">
