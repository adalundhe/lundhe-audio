...
export const NavBar = () => {
    ...
    return (
      ...
      <NavigationMenu orientation="vertical" className={`h-[80px] max-h-[80px] my-4 px-3 ${GeistSans.className}`}>
        <NavigationMenuList className="flex justify-start">
            ...
            <NavigationMenuItem className="h-[40px]">
                ...
                <NavigationMenuContent>
                    <NavigationMenuSub defaultValue="home" className="text-sm lg:ml-[100px] border bg-white w-full lg:w-[94px] lg:h-full h-[100vh] hidden lg:flex flex-col justify-center font-medium shadow-sm rounded-sm">
