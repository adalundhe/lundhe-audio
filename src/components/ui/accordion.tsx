...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    className={cn(
      ...
      "motion-safe:data-[state=open]:[&>div]:animate-in motion-safe:data-[state=open]:[&>div]:fade-in-0 motion-safe:data-[state=open]:[&>div]:slide-in-from-top-2 motion-safe:data-[state=open]:[&>div]:duration-300",
      "motion-safe:data-[state=closed]:[&>div]:animate-out motion-safe:data-[state=closed]:[&>div]:fade-out-0 motion-safe:data-[state=closed]:[&>div]:slide-out-to-top-1 motion-safe:data-[state=closed]:[&>div]:duration-200",
    )}
    {...props}
  >
