...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <NavigationMenuViewport className="lg:flex lg:justify-center lg:items-center shadow-none bg-transparent border-none mt-0" />
  </NavigationMenuPrimitive.Root>
))
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "w-full group flex flex-1 grow list-none items-center justify-around",
      className
    )}
    {...props}
  />
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex w-max items-center justify-center rounded-sm bg-background px-4 text-lg font-light transition-colors hover:text-accent-foreground focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 focus:font-light"
)

const navigationMenuLinkStyle = cva(
  "group inline-flex w-max items-center justify-center rounded-sm bg-background hover:underline text-lg font-light transition-colors hover:text-accent-foreground focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50  focus:font-light"
)
...
NavigationSubMenuTrigger.displayName = NavigationMenuPrimitive.Trigger.displayName ? `${NavigationMenuPrimitive.Trigger.displayName}-Sub` : undefined
...
NavigationSubMenuContent.displayName = NavigationMenuPrimitive.Content.displayName ? `${NavigationMenuPrimitive.Content.displayName}-Sub` : undefined
