...
export const env = createEnv({
  ...
  server: {
    ...
    AWS_S3_PRESIGN_TTL_SECONDS: z.coerce.number().optional(),
    GEAR_MEDIA_BUCKET_NAME: z.string().default("lundhe-audio-gear-photos"),
  ...
  client: {
    ...
    NEXT_PUBLIC_STRIPE_SANDBOX_PUBLISHABLE_KEY: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    AWS_S3_PRESIGN_TTL_SECONDS: process.env.AWS_S3_PRESIGN_TTL_SECONDS,
    GEAR_MEDIA_BUCKET_NAME: process.env.GEAR_MEDIA_BUCKET_NAME,
    STRIPE_SANDBOX_SECRET_KEY: process.env.STRIPE_SANDBOX_SECRET_KEY,
    NEXT_PUBLIC_STRIPE_SANDBOX_PUBLISHABLE_KEY: process.env.NEXT_PUBLIC_STRIPE_SANDBOX_PUBLISHABLE_KEY,
