...
export const env = createEnv({
  ...
  server: {
    ...
    SHOPIFY_ADMIN_API_SECRET: z.string(),
    SHOPIFY_ADMIN_API_TOKEN: z.string(),
    SHOPIFY_STOREFRONT_API_PRIVATE_ACCESS_TOKEN: z.string(),
    // NEXTAUTH_SECRET:
  ...
  runtimeEnv: {
    ...
    SHOPIFY_STOREFRONT_API_PRIVATE_ACCESS_TOKEN: process.env.SHOPIFY_STOREFRONT_API_PRIVATE_ACCESS_TOKEN
