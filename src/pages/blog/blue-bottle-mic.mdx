...
<Content>
    ...
    <div className='flex flex-row gap-4 items-center mb-4'>
        <Frame
            ...
            size={50}
            styles="self-center w-1/2"
            subtext="One of Lündhé Audio's two Blue Bottle microphones"
        />
        <Paragraph styles="w-1/2 self-center" align='left'>
...
<Content styles='gap-4'>
    ...
    <div className='mt-4 mb-4 w-full' id="blue-b0-cap">
        <Paragraph styles="w-full self-start text-tighter flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
    ...
    <div className='mb-4 w-full' id="blue-b1-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b1-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='mb-4 w-full' id="blue-b2-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b2-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='mb-4 w-full' id="blue-b3-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b3-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b4-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b4-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b5-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b5-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b6-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b6-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b7-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b7-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b8-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b8-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b9-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b9-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b10-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b10-cap" styles='text-[2vmax]' linkType='internal'>
    ...
    <div className='w-full mb-4' id="blue-b11-cap">
        <Paragraph styles="w-full self-start flex flex-col gap-4" align='justify'>
            <div className='mb-4 self-center w-3/4 text-center'>
                <BlogLink to="#blue-b11-cap" styles='text-[2vmax]' linkType='internal'>
